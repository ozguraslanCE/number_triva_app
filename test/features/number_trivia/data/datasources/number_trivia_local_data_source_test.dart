...
void main() {
  ...
  group('getLastNumberTrivia', () {
    ...
    test(
        'should return NumberTriviaModel from shared '
        'preferences when there is one in the cache', () async {
      //arrange
    ...
    test('should  throw a CacheException when there is not a cached value',
      ...
      //assert
      //removed verify because it already define above test
      expect(call(), throwsA(const TypeMatcher<CacheException>()));
    });
  });

  group('cacheNumberTrivia', () {
    const tNumberTriviaModel = NumberTriviaModel(text: 'Test Text', number: 5);
